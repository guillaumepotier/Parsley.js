	...
	window.ParsleyConfig = $.extend( true, {}, window.ParsleyConfig, {
		messages: {
			...
			, type: {
				...
				, digits:     "Denne værdi skal være cifre."
			...
			, notnull:        "Denne værdi bør ikke være nul."
			, notblank:       "Denne værdi bør ikke være tomme."
			...
			, rangelength:    "Denne værdi har en ugyldig længde. Den bør være mellem %s og %s tegn."
			...
			// parsley.extend ///////////////////////////////
			, minwords:       "Denne værdi bør have mindst %s ord."
			, maxwords:       "Denne værdi bør have maksimum %s ord."
			, rangewords:     "Denne værdi bør have mellem %s og %s ord."
