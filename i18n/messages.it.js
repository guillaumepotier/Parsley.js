  ...
  window.ParsleyConfig = $.extend( true, {}, window.ParsleyConfig, {
    messages: {
      ...
      , type: {
          ...
          , phone:      "Questo valore deve essere un numero di telefono valido."
        }
      ...
      , rangecheck:     "Devi scegliere tra %s e %s opzioni."
      ...
      , americandate:   "Questo valore deve essere una data (MM/GG/AAAA)."
    }
  });
