...
(function ($) {
  window.ParsleyConfig = $.extend( true, {}, window.ParsleyConfig, {
    messages: {
      ...
      , regexp:         "่คานี้ดูเหมือนว่าจะไม่ถูกต้อง."
      , min:            "ค่านี้ควรจะมากกว่าหรือเท่ากับ %s."
      , max:            "ค่านี้ควรจะน้อยกว่าหรือเท่ากับ %s."
      , range:          "ค่านี้ควรอยู่ระหว่าง %s และ %s."
      , minlength:      "ค่านี้สั้นเกินไป. มันควรมี %s อักขระหรือมากกว่า."
      , maxlength:      "ค่านี้ยาวเกินไป. มันควรมี %s อักขระหรือน้อยกว่า."
      , rangelength:    "ความยาวของค่านี้ไม่ถูกต้อง. มันควรมีความยาวอักขระระหว่าง %s และ %s."
