...
window.ParsleyConfig.i18n.cs = $.extend(window.ParsleyConfig.i18n.cs || {}, {
  ...
  minlength:      "Tato položka je příliš krátká. Musí mít nejméně %s znaků.",
  maxlength:      "Tato položka je příliš dlouhá. Musí mít nejvíce %s znaků.",
  length:         "Tato položka má špatnou délku. Musí mít délku od %s do %s znaků.",
