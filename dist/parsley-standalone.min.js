...
break;case "dateIso":c=/^(\d{4})\D?(0[1-9]|1[0-2])\D?([12]\d|0[1-9]|3[01])$/;break;default:return!1}return""!==a?c.test(a):!1},regexp:function(a,e){return RegExp(e,"i").test(a)},minlength:function(a,e){return a.length>=e},maxlength:function(a,e){return a.length<=e},rangelength:function(a,e){return this.minlength(a,e[0])&&this.maxlength(a,e[1])},min:function(a,e){return Number(a)>=e},max:function(a,e){return Number(a)<=e},range:function(a,e){return a>=e[0]&&a<=e[1]},equalto:function(a,e){return a===
...
this.val===a&&this.validatedOnce)return!1;this.val=a;return this.validatedOnce=!0},applyValidators:function(){for(var a=null,c=0;c<this.constraints.length;c++){var f=this.Validator.validators[this.constraints[c].name](this.val,this.constraints[c].requirements,this);!1===f?(a=!1,this.constraints[c].isValid=a):!0===f&&(this.constraints[c].isValid=!0,a=!1!==a)}return a},updateConstraint:function(a,c,f){for(var g=0;g<this.constraints.length;g++)if(this.constraints[g].name===a){this.constraints[g][c]=
f;break}},manageValidationResult:function(){for(var a=null,c=0;c<this.constraints.length;c++)!1===this.constraints[c].isValid?(this.addError(this.constraints[c]),a=!1):!0===this.constraints[c].isValid&&(this.removeError(this.constraints[c].name),a=!1!==a);this.isValid=a;return!0===this.isValid?(this.removeErrors(),this.errorClassHandler.removeClass(this.options.errorClass).addClass(this.options.successClass),this.options.listeners.onFieldSuccess(this.element,this.constraints,this),!0):!1===this.isValid?
(this.errorClassHandler.removeClass(this.options.successClass).addClass(this.options.errorClass),this.options.listeners.onFieldError(this.element,this.constraints,this),!1):a},ulErrorManagement:function(){this.ulError="#"+this.hash;this.ulTemplate=c(this.options.errors.errorsWrapper).attr("id",this.hash).addClass("parsley-error-list")},removeError:function(a){a=this.ulError+" ."+a;this.ulError&&(c(a).remove()&&0===c(this.ulError).children().length)&&c(this.ulError).remove()},removeErrors:function(){c(this.ulError).remove()},
reset:function(){this.isValid=null;this.removeErrors();this.errorClassHandler.removeClass(this.options.successClass).removeClass(this.options.errorClass);return this},addError:function(a){c(this.ulError).length||this.options.errors.container(this.element,this.ulTemplate,this.isRadioOrCheckbox)||(!this.isRadioOrCheckbox?this.$element.after(this.ulTemplate):this.$element.parent().after(this.ulTemplate));var e=a.name,f=!1!==this.options.errorMessage?"custom-error-message":e,g=this.ulError+" ."+f,f=c(this.options.errors.errorElem).addClass(f);
a=!1!==this.options.errorMessage?this.options.errorMessage:"type"===a.name?this.Validator.messages[e][a.requirements]:"undefined"===typeof this.Validator.messages[e]?this.Validator.messages.defaultMessage:this.Validator.formatMesssage(this.Validator.messages[e],a.requirements);c(g).length||c(this.ulError).append(c(f).text(a))},addListener:function(a){for(var c in a)this.options.listeners[c]=a[c]},destroy:function(){this.$element.removeClass("parsley-validated");this.reset().$element.off("."+this.type).removeData(this.type)}};
var t=function(a,c){this.initMultiple(a,c);this.inherit(a,c);this.init(a,c)};t.prototype={constructor:t,initMultiple:function(a,e){this.element=a;this.$element=c(a);this.hash=this.getName();this.isRadioOrCheckbox=!0;this.isRadio=this.$element.is("input[type=radio]");this.isCheckbox=this.$element.is("input[type=checkbox]");this.siblings='input[name="'+this.$element.attr("name")+'"]';this.$siblings=c(this.siblings);this.errorClassHandler=e.errors.classHandler(a)||this.$element.parent()},inherit:function(a,
c){var f=new s(a,c),g;for(g in f)"undefined"===typeof this[g]&&(this[g]=f[g])},getName:function(){return"parsley-"+this.$element.attr("name").replace(/(:|\.|\[|\])/g,"")},getVal:function(){if(this.isRadio)return c(this.siblings+":checked").val()||"";if(this.isCheckbox){var a=[];c(this.siblings+":checked").each(function(){a.push(c(this).val())});return a}}};var u=function(a,c){this.init("parsleyForm",a,c)};u.prototype={constructor:u,init:function(a,e,f){this.type=a;this.items=[];this.$element=c(e);
this.options=f;var g=this,l;this.$element.find(f.inputs).each(function(){l=c(this).parsley(f);null!==l&&g.items.push(l)});this.$element.on("submit."+this.type,!1,c.proxy(this.validate,this))},addListener:function(a){for(var c in a)if(/Field/.test(c))for(var f=0;f<this.items.length;f++)this.items[f].addListener(a);else this.options.listeners[c]=a[c]},validate:function(a){var c=!0;this.focusedField=!1;for(var f=0;f<this.items.length;f++)if(!1===this.items[f].validate()&&(c=!1,!this.focusedField&&"first"===
this.options.focus||"last"===this.options.focus))this.focusedField=this.items[f].$element;this.focusedField&&!c&&this.focusedField.focus();this.options.listeners.onFormSubmit(c,a,this);return c},removeErrors:function(){for(var a=0;a<this.items.length;a++)this.items[a].parsley("reset")},destroy:function(){for(var a=0;a<this.items.length;a++)this.items[a].destroy();this.$element.off("."+this.type).removeData(this.type)}};c.fn.parsley=function(a,e){function f(f,l){var n=c(f).data(l);if(!n){switch(l){case "parsleyForm":n=
new u(f,g);break;case "parsleyField":n=new s(f,g);break;case "parsleyFieldMultiple":n=new t(f,g);break;default:return}c(f).data(l,n)}return"string"===typeof a&&"function"===typeof n[a]?n[a](e):n}var g=c.extend(!0,{},c.fn.parsley.defaults,"undefined"!==typeof window.ParsleyConfig?window.ParsleyConfig:{},a,this.data()),l=null;c(this).is("form")?l=f(c(this),"parsleyForm"):c(this).is(g.inputs)&&!c(this).is(g.excluded)&&(l=f(c(this),!c(this).is("input[type=radio], input[type=checkbox]")?"parsleyField":
"parsleyFieldMultiple"));return"function"===typeof e?e():l};c.fn.parsley.Constructor=u;c.fn.parsley.defaults={inputs:"input, textarea, select",excluded:"input[type=hidden], :disabled",trigger:!1,focus:"first",validationMinlength:3,successClass:"parsley-success",errorClass:"parsley-error",errorMessage:!1,validators:{},messages:{},errors:{classHandler:function(){},container:function(){},errorsWrapper:"<ul></ul>",errorElem:"<li></li>"},listeners:{onFieldValidate:function(){return!1},onFormSubmit:function(){},
onFieldError:function(){},onFieldSuccess:function(){}}};c(window).on("load",function(){c('[data-validate="parsley"]').each(function(){c(this).parsley()})})}(window.jQuery||window.Zepto);
