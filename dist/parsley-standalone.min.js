/* Parsley dist/parsley-standalone.min.js build version 1.1.15-dev http://parsleyjs.org */
(function(b){String.prototype.trim===b&&(String.prototype.trim=function(){return this.replace(/^\s+/,"").replace(/\s+$/,"")});Array.prototype.reduce===b&&(Array.prototype.reduce=function(j){if(void 0===this||null===this)throw new TypeError;var q=Object(this),p=q.length>>>0,m=0,a;if("function"!=typeof j)throw new TypeError;if(0==p&&1==arguments.length)throw new TypeError;if(2<=arguments.length)a=arguments[1];else{do{if(m in q){a=q[m++];break}if(++m>=p)throw new TypeError;}while(1)}for(;m<p;)m in q&&
(a=j.call(b,a,q[m],m,q)),m++;return a})})();
var Zepto=function(){function b(f){return"[object Function]"==M.call(f)}function j(f){return f instanceof Object}function q(f){return j(f)&&f.__proto__==Object.prototype}function p(f){return f instanceof Array}function m(f){return"number"==typeof f.length}function a(f){return f.replace(/::/g,"/").replace(/([A-Z]+)([A-Z][a-z])/g,"$1_$2").replace(/([a-z\d])([A-Z])/g,"$1_$2").replace(/_/g,"-").toLowerCase()}function c(f){return f in B?B[f]:B[f]=RegExp("(^|\\s)"+f+"(\\s|$)")}function e(f){return"children"in
f?u.call(f.children):d.map(f.childNodes,function(f){if(1==f.nodeType)return f})}function g(f,a,d){for(s in a)d&&q(a[s])?(q(f[s])||(f[s]={}),g(f[s],a[s],d)):a[s]!==l&&(f[s]=a[s])}function k(f,a){return a===l?d(f):d(f).filter(a)}function n(f,a,d,c){return b(a)?a.call(f,d,c):a}function w(f,a){var d=f.className,b=d&&d.baseVal!==l;if(a===l)return b?d.baseVal:d;b?d.baseVal=a:f.className=a}function x(f){var a;try{return f?"true"==f||("false"==f?!1:"null"==f?null:!isNaN(a=Number(f))?a:/^[\[\{]/.test(f)?d.parseJSON(f):
...
(function(b){function j(a){return a._zid||(a._zid=k++)}function q(a,b,c,e){b=p(b);if(b.ns)var k=RegExp("(?:^| )"+b.ns.replace(" "," .* ?")+"(?: |$)");return(g[j(a)]||[]).filter(function(a){return a&&(!b.e||a.e==b.e)&&(!b.ns||k.test(a.ns))&&(!c||j(a.fn)===j(c))&&(!e||a.sel==e)})}function p(a){a=(""+a).split(".");return{e:a[0],ns:a.slice(1).sort().join(" ")}}function m(a,c,e){b.isObject(a)?b.each(a,e):a.split(/\s/).forEach(function(a){e(a,c)})}function a(a,c,e,k,n,r){var h=j(a),B=g[h]||(g[h]=[]);m(c,
e,function(c,e){var h=p(c);h.fn=e;h.sel=k;h.e in w&&(e=function(a){var d=a.relatedTarget;if(!d||d!==this&&!b.contains(this,d))return h.fn.apply(this,arguments)});h.del=n&&n(e,c);var g=h.del||e;h.proxy=function(b){var c=g.apply(a,[b].concat(b.data));!1===c&&(b.preventDefault(),b.stopPropagation());return c};h.i=B.length;B.push(h);a.addEventListener(w[h.e]||h.e,h.proxy,h.del&&("focus"==h.e||"blur"==h.e)||!!r)})}function c(a,b,c,e,k){var r=j(a);m(b||"",c,function(b,c){q(a,b,c,e).forEach(function(b){delete g[r][b.i];
a.removeEventListener(w[b.e]||b.e,b.proxy,b.del&&("focus"==b.e||"blur"==b.e)||!!k)})})}function e(a){var c,e={originalEvent:a};for(c in a)!l.test(c)&&void 0!==a[c]&&(e[c]=a[c]);b.each(s,function(b,c){e[b]=function(){this[c]=x;return a[b].apply(a,arguments)};e[c]=A});return e}var g={},k=1,n={},w={mouseenter:"mouseover",mouseleave:"mouseout"};n.click=n.mousedown=n.mouseup=n.mousemove="MouseEvents";b.event={add:a,remove:c};b.proxy=function(a,c){if(b.isFunction(a)){var e=function(){return a.apply(c,arguments)};
e._zid=j(a);return e}if("string"==typeof c)return b.proxy(a[c],a);throw new TypeError("expected function");};b.fn.bind=function(b,c){return this.each(function(){a(this,b,c)})};b.fn.unbind=function(a,b){return this.each(function(){c(this,a,b)})};b.fn.one=function(b,e){return this.each(function(g,k){a(this,b,e,null,function(a,b){return function(){var d=a.apply(k,arguments);c(k,b,a);return d}})})};var x=function(){return!0},A=function(){return!1},l=/^([A-Z]|layer[XY]$)/,s={preventDefault:"isDefaultPrevented",
stopImmediatePropagation:"isImmediatePropagationStopped",stopPropagation:"isPropagationStopped"};b.fn.delegate=function(c,g,k){return this.each(function(n,j){a(j,g,k,c,function(a){return function(h){var g,k=b(h.target).closest(c,j).get(0);if(k)return g=b.extend(e(h),{currentTarget:k,liveFired:j}),a.apply(k,[g].concat([].slice.call(arguments,1)))}})})};b.fn.undelegate=function(a,b,e){return this.each(function(){c(this,b,e,a)})};b.fn.live=function(a,c){b(document.body).delegate(this.selector,a,c);return this};
...
c;return this.each(function(){"dispatchEvent"in this&&this.dispatchEvent(a)})};b.fn.triggerHandler=function(a,c){var g,k;this.each(function(n,r){g=e("string"==typeof a?b.Event(a):a);g.data=c;g.target=r;b.each(q(r,a.type||a),function(a,b){k=b.proxy(g);if(g.isImmediatePropagationStopped())return!1})});return k};"focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select keydown keypress keyup error".split(" ").forEach(function(a){b.fn[a]=
...
(function(b,j){function q(a){return a.toLowerCase()}var p="",m,a=window.document.createElement("div"),c=/^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i,e,g,k,n,w,x,A,l={};b.each({Webkit:"webkit",Moz:"",O:"o",ms:"MS"},function(b,c){if(a.style[b+"TransitionProperty"]!==j)return p="-"+q(b)+"-",m=c,!1});e=p+"transform";l[g=p+"transition-property"]=l[k=p+"transition-duration"]=l[n=p+"transition-timing-function"]=l[w=p+"animation-name"]=l[x=p+"animation-duration"]=l[A=p+"animation-timing-function"]=
"";b.fx={off:m===j&&a.style.transitionProperty===j,speeds:{_default:400,fast:200,slow:600},cssPrefix:p,transitionEnd:m?m+"TransitionEnd":q("TransitionEnd"),animationEnd:m?m+"AnimationEnd":q("AnimationEnd")};b.fn.animate=function(a,c,e,g){b.isObject(c)&&(e=c.easing,g=c.complete,c=c.duration);c&&(c=("number"==typeof c?c:b.fx.speeds[c]||b.fx.speeds._default)/1E3);return this.anim(a,c,e,g)};b.fn.anim=function(a,d,m,p){var u,v={},r,h="",B=this,C,D=b.fx.transitionEnd;d===j&&(d=0.4);b.fx.off&&(d=0);if("string"==
typeof a)v[w]=a,v[x]=d+"s",v[A]=m||"linear",D=b.fx.animationEnd;else{r=[];for(u in a)c.test(u)?h+=u+"("+a[u]+") ":(v[u]=a[u],r.push(q(u.replace(/([a-z])([A-Z])/,"$1-$2"))));h&&(v[e]=h,r.push(e));0<d&&"object"===typeof a&&(v[g]=r.join(", "),v[k]=d+"s",v[n]=m||"linear")}C=function(a){if("undefined"!==typeof a){if(a.target!==a.currentTarget)return;b(a.target).unbind(D,arguments.callee)}b(this).css(l);p&&p.call(this)};0<d&&this.bind(D,C);this.size()&&this.get(0).clientLeft;this.css(v);0>=d&&setTimeout(function(){B.each(function(){C.call(this)})},
...
"json":s.test(a)?"script":d.test(a)&&"xml")||"text"}function e(a){a.processData&&n(a.data)&&(a.data=b.param(a.data,a.traditional));if(a.data&&(!a.type||"GET"==a.type.toUpperCase()))a.url=(a.url+"&"+a.data).replace(/[&?]{1,2}/,"?")}function g(a,c,e,d){var k=b.isArray(c);b.each(c,function(c,h){d&&(c=e?d:d+"["+(k?"":c)+"]");!d&&k?a.add(h.name,h.value):(e?b.isArray(h):n(h))?g(a,h,e,c):a.add(c,h)})}var k=0,n=b.isObject,w=window.document,x,A,l=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,s=/^(?:text|application)\/javascript/i,
d=/^(?:text|application)\/xml/i,y="application/json",z="text/html",u=/^\s*$/;b.active=0;b.ajaxJSONP=function(c){if(!("type"in c))return b.ajax(c);var d="jsonp"+ ++k,g=w.createElement("script"),n={abort:function(){b(g).remove();d in window&&(window[d]=a);m("abort",n,c)}},j;c.error&&(g.onerror=function(){n.abort();c.error()});window[d]=function(a){clearTimeout(j);b(g).remove();delete window[d];q(a,n,c)};e(c);g.src=c.url.replace(/=\?/,"="+d);b("head").append(g);0<c.timeout&&(j=setTimeout(function(){n.abort();
m("timeout",n,c)},c.timeout));return n};b.ajaxSettings={type:"GET",beforeSend:a,success:a,error:a,complete:a,context:null,global:!0,xhr:function(){return new window.XMLHttpRequest},accepts:{script:"text/javascript, application/javascript",json:y,xml:"application/xml, text/xml",html:z,text:"text/plain"},crossDomain:!1,timeout:0,processData:!0};b.ajax=function(d){var h=b.extend({},d||{});for(x in b.ajaxSettings)void 0===h[x]&&(h[x]=b.ajaxSettings[x]);h.global&&0===b.active++&&j(h,null,"ajaxStart");
h.crossDomain||(h.crossDomain=/^([\w-]+:)?\/\/([^\/]+)/.test(h.url)&&RegExp.$2!=window.location.host);var g=h.dataType;d=/=\?/.test(h.url);if("jsonp"==g||d)return d||(h.url=(h.url+"&callback=?").replace(/[&?]{1,2}/,"?")),b.ajaxJSONP(h);h.url||(h.url=window.location.toString());e(h);d=h.accepts[g];var k={},n=/^([\w-]+:)\/\//.test(h.url)?RegExp.$1:window.location.protocol,l=b.ajaxSettings.xhr(),m;h.crossDomain||(k["X-Requested-With"]="XMLHttpRequest");d&&(k.Accept=d,-1<d.indexOf(",")&&(d=d.split(",",
2)[0]),l.overrideMimeType&&l.overrideMimeType(d));if(h.contentType||!1!==h.contentType&&h.data&&"GET"!=h.type.toUpperCase())k["Content-Type"]=h.contentType||"application/x-www-form-urlencoded";h.headers=b.extend(k,h.headers||{});l.onreadystatechange=function(){if(4==l.readyState){clearTimeout(m);var a,e=!1;if(200<=l.status&&300>l.status||304==l.status||0==l.status&&"file:"==n){g=g||c(l.getResponseHeader("content-type"));a=l.responseText;try{"script"==g?(0,eval)(a):"xml"==g?a=l.responseXML:"json"==
g&&(a=u.test(a)?null:b.parseJSON(a))}catch(d){e=d}e?p(e,"parsererror",l,h):q(a,l,h)}else p(null,"error",l,h)}};l.open(h.type,h.url,"async"in h?h.async:!0);for(A in h.headers)l.setRequestHeader(A,h.headers[A]);d=h.context;!1===h.beforeSend.call(d,l,h)||!1===j(h,d,"ajaxBeforeSend",[l,h])?d=!1:(j(h,d,"ajaxSend",[l,h]),d=void 0);if(!1===d)return l.abort(),!1;0<h.timeout&&(m=setTimeout(function(){l.onreadystatechange=a;l.abort();p(null,"timeout",l,h)},h.timeout));l.send(h.data?h.data:null);return l};b.get=
...
(function(b){function j(e,g){var k=e[c],k=k&&p[k];if(void 0===g)return k||q(e);if(k){if(g in k)return k[g];var n=a(g);if(n in k)return k[n]}return m.call(b(e),g)}function q(e,g,k){var n=e[c]||(e[c]=++b.uuid),j;if(!(j=p[n])){j=p;var m={};b.each(e.attributes,function(c,e){0==e.name.indexOf("data-")&&(m[a(e.name.replace("data-",""))]=b.zepto.deserializeValue(e.value))});j=j[n]=m}e=j;void 0!==g&&(e[a(g)]=k);return e}var p={},m=b.fn.data,a=b.camelCase,c=b.expando="Zepto"+ +new Date;b.fn.data=function(a,
c){return void 0===c?b.isPlainObject(a)?this.each(function(c,g){b.each(a,function(a,c){q(g,a,c)})}):0==this.length?void 0:j(this[0],a):this.each(function(){q(this,a,c)})};b.fn.removeData=function(e){"string"==typeof e&&(e=e.split(/\s+/));return this.each(function(){var g=this[c],k=g&&p[g];k&&b.each(e,function(){delete k[a(this)]})})}})(Zepto);
(function(b,j){function q(a,c,k,n,m){"function"==typeof c&&!m&&(m=c,c=j);k={opacity:k};n&&(k.scale=n,a.css(b.fx.cssPrefix+"transform-origin","0 0"));return a.animate(k,c,null,m)}function p(c,g,k,j){return q(c,g,0,k,function(){a.call(b(this));j&&j.call(this)})}var m=b.fn.show,a=b.fn.hide,c=b.fn.toggle;b.fn.show=function(a,c){m.call(this);a===j?a=0:this.css("opacity",0);return q(this,a,1,"1,1",c)};b.fn.hide=function(c,b){return c===j?a.call(this):p(this,c,"0,0",b)};b.fn.toggle=function(a,g){return a===
j||"boolean"==typeof a?c.call(this,a):this.each(function(){var c=b(this);c["none"==c.css("display")?"show":"hide"](a,g)})};b.fn.fadeTo=function(a,c,b){return q(this,a,c,null,b)};b.fn.fadeIn=function(a,c){var b=this.css("opacity");0<b?this.css("opacity",0):b=1;return m.call(this).fadeTo(a,b,c)};b.fn.fadeOut=function(a,c){return p(this,a,null,c)};b.fn.fadeToggle=function(a,c){return this.each(function(){var k=b(this);k[0==k.css("opacity")||"none"==k.css("display")?"fadeIn":"fadeOut"](a,c)})}})(Zepto);!function(b){var j=function(a){this.messages={defaultMessage:"This value seems to be invalid.",type:{email:"This value should be a valid email.",url:"This value should be a valid url.",urlstrict:"This value should be a valid url.",number:"This value should be a valid number.",digits:"This value should be digits.",dateIso:"This value should be a valid date (YYYY-MM-DD).",alphanum:"This value should be alphanumeric."},notnull:"This value should not be null.",notblank:"This value should not be blank.",
...
break;case "dateIso":b=/^(\d{4})\D?(0[1-9]|1[0-2])\D?([12]\d|0[1-9]|3[01])$/;break;default:return!1}return""!==a?b.test(a):!1},regexp:function(a,c,b){return RegExp(c,b.options.regexpFlag||"").test(a)},minlength:function(a,c){return a.length>=c},maxlength:function(a,c){return a.length<=c},rangelength:function(a,c){return this.minlength(a,c[0])&&this.maxlength(a,c[1])},min:function(a,c){return Number(a)>=c},max:function(a,c){return Number(a)<=c},range:function(a,c){return a>=c[0]&&a<=c[1]},equalto:function(a,
c,e){e.options.validateIfUnchanged=!0;return a===b(c).val()},remote:function(a,c,e){var g={},k={};g[e.$element.attr("name")]=a;"undefined"!==typeof e.options.remoteDatatype&&(k={dataType:e.options.remoteDatatype});var j=function(a,c){e.removeError("remote");e.updtConstraint({name:"remote",isValid:a},c);e.manageValidationResult()},m=function(a){if("object"===typeof a)return a;try{a=b.parseJSON(a)}catch(c){}return a},p=function(a){return"object"===typeof a&&null!==a?"undefined"!==typeof a.error?a.error:
"undefined"!==typeof a.message?a.message:null:null};b.ajax(b.extend({},{url:c,data:g,type:e.options.remoteMethod||"GET",success:function(a){a=m(a);j(1===a||!0===a||"object"===typeof a&&null!==a&&"undefined"!==typeof a.success,p(a))},error:function(a){a=m(a);j(!1,p(a))}},k));return null},mincheck:function(a,c){return this.minlength(a,c)},maxcheck:function(a,c){return this.maxlength(a,c)},rangecheck:function(a,c){return this.rangelength(a,c)}},init:function(a){var c=a.validators;a=a.messages;for(var b in c)this.addValidator(b,
...
this.hasConstraints()&&this.bindValidationEvents()},setParent:function(a){this.$parent=b(a)},getParent:function(){return this.$parent},bindHtml5Constraints:function(){if(this.$element.hasClass("required")||this.$element.attr("required"))this.options.required=!0;"undefined"!==typeof this.$element.attr("type")&&RegExp(this.$element.attr("type"),"i").test("email url number range")&&(this.options.type=this.$element.attr("type"),RegExp(this.options.type,"i").test("number range")&&(this.options.type="number",
"undefined"!==typeof this.$element.attr("min")&&this.$element.attr("min").length&&(this.options.min=this.$element.attr("min")),"undefined"!==typeof this.$element.attr("max")&&this.$element.attr("max").length&&(this.options.max=this.$element.attr("max"))));"string"===typeof this.$element.attr("pattern")&&this.$element.attr("pattern").length&&(this.options.regexp=this.$element.attr("pattern"))},addConstraints:function(){for(var a in this.options){var c={};c[a]=this.options[a];this.addConstraint(c,!0)}},
addConstraint:function(a,c){for(var b in a)b=b.toLowerCase(),"function"===typeof this.Validator.validators[b]&&(this.constraints[b]={name:b,requirements:a[b],isValid:null},"required"===b&&(this.isRequired=!0),this.addCustomConstraintMessage(b));"undefined"===typeof c&&this.bindValidationEvents()},updateConstraint:function(a,c){for(var b in a)this.updtConstraint({name:b,requirements:a[b],isValid:null},c)},updtConstraint:function(a,c){this.constraints[a.name]=b.extend(!0,this.constraints[a.name],a);
"string"===typeof c&&(this.Validator.messages[a.name]=c);this.bindValidationEvents()},removeConstraint:function(a){a=a.toLowerCase();delete this.constraints[a];"required"===a&&(this.isRequired=!1);this.hasConstraints()?this.bindValidationEvents():"ParsleyForm"===typeof this.getParent()?this.getParent().removeItem(this.$element):this.destroy()},addCustomConstraintMessage:function(a){var c=a+("type"===a&&"undefined"!==typeof this.options[a]?this.options[a].charAt(0).toUpperCase()+this.options[a].substr(1):
"")+"Message";"undefined"!==typeof this.options[c]&&this.Validator.addMessage("type"===a?this.options[a]:a,this.options[c],"type"===a)},bindValidationEvents:function(){this.isValid=null;this.$element.addClass("parsley-validated");this.$element.off("."+this.type);this.options.remote&&!/change/i.test(this.options.trigger)&&(this.options.trigger=!this.options.trigger?"change":" change");var a=(!this.options.trigger?"":this.options.trigger)+(/key/i.test(this.options.trigger)?"":" keyup");this.$element.is("select")&&
(a+=/change/i.test(a)?"":" change");a=a.replace(/^\s+/g,"").replace(/\s+$/g,"");this.$element.on((a+" ").split(" ").join("."+this.type+" "),!1,b.proxy(this.eventValidation,this))},generateHash:function(){return"parsley-"+(Math.random()+"").substring(2)},getHash:function(){return this.hash},getVal:function(){return this.$element.val()},eventValidation:function(a){var c=this.getVal();if("keyup"===a.type&&!/keyup/i.test(this.options.trigger)&&!this.validatedOnce||"change"===a.type&&!/change/i.test(this.options.trigger)&&
!this.validatedOnce||!this.isRadioOrCheckbox&&c.length<this.options.validationMinlength&&!this.validatedOnce)return!0;this.validate(!0)},isFieldValid:function(){return this.validate(!1)},hasConstraints:function(){for(var a in this.constraints)return!0;return!1},validate:function(a){var c=this.getVal(),b=null;if(!this.hasConstraints())return null;if(this.options.listeners.onFieldValidate(this.element,this)||""===c&&!this.isRequired)return this.reset(),null;if(!this.needsValidation(c))return this.isValid;
this.errorBubbling="undefined"!==typeof a?a:!0;b=this.applyValidators();this.errorBubbling&&this.manageValidationResult();return b},needsValidation:function(a){if(!this.options.validateIfUnchanged&&null!==this.isValid&&this.val===a&&this.validatedOnce)return!1;this.val=a;return this.validatedOnce=!0},applyValidators:function(){var a=null,c;for(c in this.constraints){var b=this.Validator.validators[this.constraints[c].name](this.val,this.constraints[c].requirements,this);!1===b?(a=!1,this.constraints[c].isValid=
a):!0===b&&(this.constraints[c].isValid=!0,a=!1!==a)}return a},manageValidationResult:function(){var a=null,b;for(b in this.constraints)!1===this.constraints[b].isValid?(this.manageError(this.constraints[b]),a=!1):!0===this.constraints[b].isValid&&(this.removeError(this.constraints[b].name),a=!1!==a);this.isValid=a;return!0===this.isValid?(this.removeErrors(),this.errorClassHandler.removeClass(this.options.errorClass).addClass(this.options.successClass),this.options.listeners.onFieldSuccess(this.element,
this.constraints,this),!0):!1===this.isValid?(this.errorClassHandler.removeClass(this.options.successClass).addClass(this.options.errorClass),this.options.listeners.onFieldError(this.element,this.constraints,this),!1):a},ulErrorManagement:function(){this.ulError="#"+this.hash;this.ulTemplate=b(this.options.errors.errorsWrapper).attr("id",this.hash).addClass("parsley-error-list")},removeError:function(a){a=this.ulError+" ."+a;this.options.animate?b(a).fadeOut(this.options.animateDuration,function(){b(this).remove()}):
b(a).remove();this.ulError&&0===b(this.ulError).children().length&&this.removeErrors()},addError:function(a){for(var c in a){var e=b(this.options.errors.errorElem).addClass(c);b(this.ulError).append(this.options.animate?b(e).text(a[c]).hide().fadeIn(this.options.animateDuration):b(e).text(a[c]))}},removeErrors:function(){this.options.animate?b(this.ulError).fadeOut(this.options.animateDuration,function(){b(this).remove()}):b(this.ulError).remove()},reset:function(){this.isValid=null;this.removeErrors();
this.validatedOnce=!1;this.errorClassHandler.removeClass(this.options.successClass).removeClass(this.options.errorClass);for(var a in this.constraints)this.constraints[a].isValid=null;return this},manageError:function(a){b(this.ulError).length||this.manageErrorContainer();if(!("required"===a.name&&null!==this.getVal()&&0<this.getVal().length)&&(!this.isRequired||!("required"!==a.name&&(null===this.getVal()||0===this.getVal().length)))){var c=a.name,e=!1!==this.options.errorMessage?"custom-error-message":
c,g={};a=!1!==this.options.errorMessage?this.options.errorMessage:"type"===a.name?this.Validator.messages[c][a.requirements]:"undefined"===typeof this.Validator.messages[c]?this.Validator.messages.defaultMessage:this.Validator.formatMesssage(this.Validator.messages[c],a.requirements);b(this.ulError+" ."+e).length||(g[e]=a,this.addError(g))}},manageErrorContainer:function(){var a=this.options.errorContainer||this.options.errors.container(this.element,this.isRadioOrCheckbox),c=this.options.animate?
this.ulTemplate.show():this.ulTemplate;"undefined"!==typeof a?b(a).append(c):!this.isRadioOrCheckbox?this.$element.after(c):this.$element.parent().after(c)},addListener:function(a){for(var b in a)this.options.listeners[b]=a[b]},destroy:function(){this.$element.removeClass("parsley-validated");this.reset().$element.off("."+this.type).removeData(this.type)}};var p=function(a,b,e){this.initMultiple(a,b);this.inherit(a,b);this.Validator=new j(b);this.init(a,e||"ParsleyFieldMultiple")};p.prototype={constructor:p,
initMultiple:function(a,c){this.element=a;this.$element=b(a);this.group=c.group||!1;this.hash=this.getName();this.siblings=this.group?'[data-group="'+this.group+'"]':'input[name="'+this.$element.attr("name")+'"]';this.isRadioOrCheckbox=!0;this.isRadio=this.$element.is("input[type=radio]");this.isCheckbox=this.$element.is("input[type=checkbox]");this.errorClassHandler=c.errors.classHandler(a,this.isRadioOrCheckbox)||this.$element.parent()},inherit:function(a,b){var e=new q(a,b,"ParsleyFieldMultiple"),
g;for(g in e)"undefined"===typeof this[g]&&(this[g]=e[g])},getName:function(){if(this.group)return"parsley-"+this.group;if("undefined"===typeof this.$element.attr("name"))throw"A radio / checkbox input must have a data-group attribute or a name to be Parsley validated !";return"parsley-"+this.$element.attr("name").replace(/(:|\.|\[|\])/g,"")},getVal:function(){if(this.isRadio)return b(this.siblings+":checked").val()||"";if(this.isCheckbox){var a=[];b(this.siblings+":checked").each(function(){a.push(b(this).val())});
return a}},bindValidationEvents:function(){this.isValid=null;this.$element.addClass("parsley-validated");this.$element.off("."+this.type);var a=this,c=(!this.options.trigger?"":this.options.trigger)+(/change/i.test(this.options.trigger)?"":" change"),c=c.replace(/^\s+/g,"").replace(/\s+$/g,"");b(this.siblings).each(function(){b(this).on(c.split(" ").join("."+a.type+" "),!1,b.proxy(a.eventValidation,a))})}};var m=function(a,b,e){this.init(a,b,e||"parsleyForm")};m.prototype={constructor:m,init:function(a,
...
b(a).parsley();for(var c=0;c<this.items.length;c++)if(this.items[c].hash===a.hash)return this.items[c].destroy(),this.items.splice(c,1),!0;return!1},validate:function(a){var b=!0;this.focusedField=!1;for(var e=0;e<this.items.length;e++)if("undefined"!==typeof this.items[e]&&!1===this.items[e].validate()&&(b=!1,!this.focusedField&&"first"===this.options.focus||"last"===this.options.focus))this.focusedField=this.items[e].$element;this.focusedField&&!b&&this.focusedField.focus();this.options.listeners.onFormSubmit(b,
a,this);return b},isValid:function(){for(var a=0;a<this.items.length;a++)if(!1===this.items[a].isFieldValid())return!1;return!0},removeErrors:function(){for(var a=0;a<this.items.length;a++)this.items[a].parsley("reset")},destroy:function(){for(var a=0;a<this.items.length;a++)this.items[a].destroy();this.$element.off("."+this.type).removeData(this.type)},reset:function(){for(var a=0;a<this.items.length;a++)this.items[a].reset()}};b.fn.parsley=function(a,c){function e(e,k){var j=b(e).data(k);if(!j){switch(k){case "parsleyForm":j=
new m(e,g,"parsleyForm");break;case "parsleyField":j=new q(e,g,"parsleyField");break;case "parsleyFieldMultiple":j=new p(e,g,"parsleyFieldMultiple");break;default:return}b(e).data(k,j)}return"string"===typeof a&&"function"===typeof j[a]?(j=j[a](c),"undefined"!==typeof j?j:b(e)):j}var g=b.extend(!0,{},b.fn.parsley.defaults,"undefined"!==typeof window.ParsleyConfig?window.ParsleyConfig:{},a,this.data()),k=null;b(this).is("form")?k=e(b(this),"parsleyForm"):b(this).is(g.inputs)&&!b(this).is(g.excluded)&&
(k=e(b(this),!b(this).is("input[type=radio], input[type=checkbox]")?"parsleyField":"parsleyFieldMultiple"));return"function"===typeof c?c():k};b.fn.parsley.Constructor=m;b.fn.parsley.defaults={inputs:"input, textarea, select",excluded:"input[type=hidden], :disabled",trigger:!1,animate:!0,animateDuration:300,focus:"first",validationMinlength:3,successClass:"parsley-success",errorClass:"parsley-error",errorMessage:!1,validators:{},messages:{},validateIfUnchanged:!1,errors:{classHandler:function(){},
container:function(){},errorsWrapper:"<ul></ul>",errorElem:"<li></li>"},listeners:{onFieldValidate:function(){return!1},onFormSubmit:function(){},onFieldError:function(){},onFieldSuccess:function(){}}};b(window).on("load",function(){b('[data-validate="parsley"]').each(function(){b(this).parsley()})})}(window.jQuery||window.Zepto);
