...
a.name&&null!==this.getVal()&&0<this.getVal().length)&&(!this.isRequired||!("required"!==a.name&&(null===this.getVal()||0===this.getVal().length)))){!1==this.options.multipleErrorMessages&&("required"==a.name||"type"==a.name||0<b(this.ulError).find(".type").length)&&b(this.ulError).empty();var c=a.name,e=!1!==this.options.errorMessage?"custom-error-message":c,g={};a=!1!==this.options.errorMessage?this.options.errorMessage:"type"===a.name?this.Validator.messages[c][a.requirements]:"undefined"===typeof this.Validator.messages[c]?
