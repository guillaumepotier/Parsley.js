/* Parsley dist/parsley-standalone.min.js build version 1.1.15 http://parsleyjs.org */
...
f?u.call(f.children):d.map(f.childNodes,function(f){if(1==f.nodeType)return f})}function g(f,a,d){for(s in a)d&&q(a[s])?(q(f[s])||(f[s]={}),g(f[s],a[s],d)):a[s]!==k&&(f[s]=a[s])}function j(f,a){return a===k?d(f):d(f).filter(a)}function n(f,a,d,c){return b(a)?a.call(f,d,c):a}function w(f,a){var d=f.className,b=d&&d.baseVal!==k;if(a===k)return b?d.baseVal:d;b?d.baseVal=a:f.className=a}function x(f){var a;try{return f?"true"==f||("false"==f?!1:"null"==f?null:!isNaN(a=Number(f))?a:/^[\[\{]/.test(f)?d.parseJSON(f):
f):f}catch(b){return f}}function A(f,a){a(f);for(var d in f.childNodes)A(f.childNodes[d],a)}var k,s,d,y,z=[],u=z.slice,v=z.filter,r=window.document,h={},B={},C=r.defaultView.getComputedStyle,D={"column-count":1,columns:1,"font-weight":1,"line-height":1,opacity:1,"z-index":1,zoom:1},H=/^\s*<(\w+|!)[^>]*>/,N=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,I=/^(?:body|html)$/i,O="val css html text data width height offset".split(" "),F=r.createElement("table"),J=r.createElement("tr"),
...
b){a.call(d,b,d)});return this},filter:function(a){return b(a)?this.not(this.not(a)):d(v.call(this,function(d){return t.matches(d,a)}))},add:function(a,b){return d(E(this.concat(d(a,b))))},is:function(a){return 0<this.length&&t.matches(this[0],a)},not:function(a){var c=[];if(b(a)&&a.call!==k)this.each(function(d){a.call(this,d)||c.push(this)});else{var e="string"==typeof a?this.filter(a):m(a)&&b(a.item)?u.call(a):d(a);this.forEach(function(a){0>e.indexOf(a)&&c.push(a)})}return d(c)},has:function(a){return this.filter(function(){return l(a)?
...
c+(c?" ":"")+y.join(" "))})},removeClass:function(a){return this.each(function(d){if(a===k)return w(this,"");y=w(this);n(this,a,d,y).split(/\s+/g).forEach(function(a){y=y.replace(c(a)," ")});w(this,y.trim())})},toggleClass:function(a,b){return this.each(function(c){c=n(this,a,c,w(this));(b===k?!d(this).hasClass(c):b)?d(this).addClass(c):d(this).removeClass(c)})},scrollTop:function(){if(this.length)return"scrollTop"in this[0]?this[0].scrollTop:this[0].scrollY},position:function(){if(this.length){var a=
...
(function(b,l){function q(a){return a.toLowerCase()}var p="",m,a=window.document.createElement("div"),c=/^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i,e,g,j,n,w,x,A,k={};b.each({Webkit:"webkit",Moz:"",O:"o",ms:"MS"},function(b,c){if(a.style[b+"TransitionProperty"]!==l)return p="-"+q(b)+"-",m=c,!1});e=p+"transform";k[g=p+"transition-property"]=k[j=p+"transition-duration"]=k[n=p+"transition-timing-function"]=k[w=p+"animation-name"]=k[x=p+"animation-duration"]=k[A=p+"animation-timing-function"]=
...
function(a,c){return b.ajax({url:a,success:c})};b.post=function(a,c,e,d){b.isFunction(c)&&(d=d||e,e=c,c=null);return b.ajax({type:"POST",url:a,data:c,success:e,dataType:d})};b.getJSON=function(a,c){return b.ajax({url:a,success:c,dataType:"json"})};b.fn.load=function(a,c){if(!this.length)return this;var e=this,d=a.split(/\s/),g;1<d.length&&(a=d[0],g=d[1]);b.get(a,function(a){e.html(g?b("<div>").html(a.replace(k,"")).find(g):a);c&&c.apply(e,arguments)});return this};var v=encodeURIComponent;b.param=
function(a,c){var b=[];b.add=function(a,c){this.push(v(a)+"="+v(c))};g(b,a,c);return b.join("&").replace(/%20/g,"+")}})(Zepto);
(function(b){function l(e,g){var j=e[c],j=j&&p[j];if(void 0===g)return j||q(e);if(j){if(g in j)return j[g];var n=a(g);if(n in j)return j[n]}return m.call(b(e),g)}function q(e,g,j){var n=e[c]||(e[c]=++b.uuid),l;if(!(l=p[n])){l=p;var m={};b.each(e.attributes,function(c,e){0==e.name.indexOf("data-")&&(m[a(e.name.replace("data-",""))]=b.zepto.deserializeValue(e.value))});l=l[n]=m}e=l;void 0!==g&&(e[a(g)]=j);return e}var p={},m=b.fn.data,a=b.camelCase,c=b.expando="Zepto"+ +new Date;b.fn.data=function(a,
...
(function(b,l){function q(a,c,j,n,m){"function"==typeof c&&!m&&(m=c,c=l);j={opacity:j};n&&(j.scale=n,a.css(b.fx.cssPrefix+"transform-origin","0 0"));return a.animate(j,c,null,m)}function p(c,g,j,n){return q(c,g,0,j,function(){a.call(b(this));n&&n.call(this)})}var m=b.fn.show,a=b.fn.hide,c=b.fn.toggle;b.fn.show=function(a,c){m.call(this);a===l?a=0:this.css("opacity",0);return q(this,a,1,"1,1",c)};b.fn.hide=function(c,b){return c===l?a.call(this):p(this,c,"0,0",b)};b.fn.toggle=function(a,g){return a===
...
min:function(a,c){return Number(a)>=c},max:function(a,c){return Number(a)<=c},range:function(a,c){return a>=c[0]&&a<=c[1]},equalto:function(a,c,e){e.options.validateIfUnchanged=!0;return a===b(c).val()},remote:function(a,c,e){var g={},j={};g[e.$element.attr("name")]=a;"undefined"!==typeof e.options.remoteDatatype&&(j={dataType:e.options.remoteDatatype});var n=function(a,c){"undefined"!==typeof c&&("undefined"!==typeof e.Validator.messages.remote&&c!==e.Validator.messages.remote)&&b(e.ulError+" .remote").remove();
e.updtConstraint({name:"remote",valid:a},c);e.manageValidationResult()},m=function(a){if("object"===typeof a)return a;try{a=b.parseJSON(a)}catch(c){}return a},l=function(a){return"object"===typeof a&&null!==a?"undefined"!==typeof a.error?a.error:"undefined"!==typeof a.message?a.message:null:null};b.ajax(b.extend({},{url:c,data:g,type:e.options.remoteMethod||"GET",success:function(a){a=m(a);n(1===a||!0===a||"object"===typeof a&&null!==a&&"undefined"!==typeof a.success,l(a))},error:function(a){a=m(a);
n(!1,l(a))}},j));return null},mincheck:function(a,c){return this.minlength(a,c)},maxcheck:function(a,c){return this.maxlength(a,c)},rangecheck:function(a,c){return this.rangelength(a,c)}},init:function(a){var c=a.validators;a=a.messages;for(var b in c)this.addValidator(b,c[b]);for(b in a)this.addMessage(b,a[b])},formatMesssage:function(a,c){if("object"===typeof c){for(var b in c)a=this.formatMesssage(a,c[b]);return a}return"string"===typeof a?a.replace(/%s/i,c):""},addValidator:function(a,c){this.validators[a]=
...
return!1},validate:function(a){var c=this.getVal(),b=null;if(!this.hasConstraints())return null;if(this.options.listeners.onFieldValidate(this.element,this)||""===c&&!this.isRequired)return this.reset(),null;if(!this.needsValidation(c))return this.valid;this.errorBubbling="undefined"!==typeof a?a:!0;b=this.applyValidators();this.errorBubbling&&this.manageValidationResult();return b},needsValidation:function(a){if(!this.options.validateIfUnchanged&&null!==this.valid&&this.val===a&&this.validatedOnce)return!1;
this.val=a;return this.validatedOnce=!0},applyValidators:function(){var a=null,c;for(c in this.constraints){var b=this.Validator.validators[this.constraints[c].name](this.val,this.constraints[c].requirements,this);!1===b?(a=!1,this.constraints[c].valid=a):!0===b&&(this.constraints[c].valid=!0,a=!1!==a)}return a},manageValidationResult:function(){var a=null,b;for(b in this.constraints)!1===this.constraints[b].valid?(this.manageError(this.constraints[b]),a=!1):!0===this.constraints[b].valid&&(this.removeError(this.constraints[b].name),
...
b(this.options.errors.errorsWrapper).attr("id",this.hash).addClass("parsley-error-list")},removeError:function(a){a=this.ulError+" ."+a;this.options.animate?b(a).fadeOut(this.options.animateDuration,function(){b(this).remove()}):b(a).remove();this.ulError&&0===b(this.ulError).children().length&&this.removeErrors()},addError:function(a){for(var c in a){var e=b(this.options.errors.errorElem).addClass(c);b(this.ulError).append(this.options.animate?b(e).text(a[c]).hide().fadeIn(this.options.animateDuration):
b(e).text(a[c]))}},removeErrors:function(){this.options.animate?b(this.ulError).fadeOut(this.options.animateDuration,function(){b(this).remove()}):b(this.ulError).remove()},reset:function(){this.valid=null;this.removeErrors();this.validatedOnce=!1;this.errorClassHandler.removeClass(this.options.successClass).removeClass(this.options.errorClass);for(var a in this.constraints)this.constraints[a].valid=null;return this},manageError:function(a){b(this.ulError).length||this.manageErrorContainer();if(!("required"===
a.name&&null!==this.getVal()&&0<this.getVal().length)&&(!this.isRequired||!("required"!==a.name&&(null===this.getVal()||0===this.getVal().length)))){var c=a.name,e=!1!==this.options.errorMessage?"custom-error-message":c,g={};a=!1!==this.options.errorMessage?this.options.errorMessage:"type"===a.name?this.Validator.messages[c][a.requirements]:"undefined"===typeof this.Validator.messages[c]?this.Validator.messages.defaultMessage:this.Validator.formatMesssage(this.Validator.messages[c],a.requirements);
...
this.reset().$element.off("."+this.type).removeData(this.type)}};var p=function(a,b,e){this.initMultiple(a,b);this.inherit(a,b);this.Validator=new l(b);this.init(a,e||"ParsleyFieldMultiple")};p.prototype={constructor:p,initMultiple:function(a,c){this.element=a;this.$element=b(a);this.group=c.group||!1;this.hash=this.getName();this.siblings=this.group?'[data-group="'+this.group+'"]':'input[name="'+this.$element.attr("name")+'"]';this.isRadioOrCheckbox=!0;this.isRadio=this.$element.is("input[type=radio]");
