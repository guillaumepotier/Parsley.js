...
d.map=function(f,a){var b,c=[],e;if(m(f))for(e=0;e<f.length;e++)b=a(f[e],e),null!=b&&c.push(b);else for(e in f)b=a(f[e],e),null!=b&&c.push(b);return 0<c.length?d.fn.concat.apply([],c):c};d.each=function(f,a){var d;if(m(f))for(d=0;d<f.length&&!1!==a.call(f[d],d,f[d]);d++);else for(d in f)if(!1===a.call(f[d],d,f[d]))break;return f};d.grep=function(a,d){return v.call(a,d)};window.JSON&&(d.parseJSON=JSON.parse);d.fn={forEach:z.forEach,reduce:z.reduce,push:z.push,sort:z.sort,indexOf:z.indexOf,concat:z.concat,
...
this.isCheckbox=this.$element.is("input[type=checkbox]");this.isSelect=this.$element.is("select");this.errorClassHandler=c.errors.classHandler(a,this.isRadioOrCheckbox)||this.$element.parent()},inherit:function(a,b){var e=new q(a,b,"ParsleyFieldMultiple"),g;for(g in e)"undefined"===typeof this[g]&&(this[g]=e[g])},getName:function(){if(this.group)return"parsley-"+this.group;if("undefined"===typeof this.$element.attr("name"))throw"A radio / checkbox input must have a data-group attribute or a name to be Parsley validated !";
