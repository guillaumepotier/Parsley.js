...
"").replace(/\s+$/g,"");d(this.siblings).each(function(){d(this).on(b.split(" ").join("."+a.type+" "),!1,d.proxy(a.eventValidation,a))})}};var k=function(a,b,c){this.init(a,b,c||"parsleyForm")};k.prototype={constructor:k,init:function(a,b,c){this.type=c;this.items=[];this.$element=d(a);this.options=b;var f=this;this.$element.find(b.inputs).each(function(){f.addItem(this)});if(this.$element.is("form"))this.$form=this.$element;else{this.$form=this.$element.parents("form").first();this.$element.find("input,textarea").on("keypress",
!1,function(a){var b=d(this);if(""==b.attr("type")||"text"===b.attr("type"))13==(a.keyCode?a.keyCode:a.which)&&g(this)});this.$element.find("input[type=submit], button").on("click",!1,function(){g(this)});var g=function(a){d(a).attr("data-causedsubmit",!0)}}this.$form.on("submit."+this.type,!1,d.proxy(this.onSubmit,this))},addListener:function(a){for(var b in a)if(/Field/.test(b))for(var c=0;c<this.items.length;c++)this.items[c].addListener(a);else this.options.listeners[b]=a[b]},addItem:function(a){if(d(a).is(this.options.excluded))return!1;
