...
!0;return a===d(b).val()},remote:function(a,b,c){var e={},f={};e[c.$element.attr("name")]=a;"undefined"!==typeof c.options.remoteDatatype&&(f={dataType:c.options.remoteDatatype});var l=function(a,b){c.removeError("remote");c.updtConstraint({name:"remote",isValid:a},b);c.manageValidationResult()},n=function(a){if("object"===typeof a)return a;try{a=d.parseJSON(a)}catch(b){}return a},g=function(a){return"object"===typeof a&&null!==a?"undefined"!==typeof a.error?a.error:"undefined"!==typeof a.message?
a.message:null:null};d.ajax(d.extend({},{url:b,data:e,async:c.async,type:c.options.remoteMethod||"GET",success:function(a){a=n(a);l(1===a||!0===a||"object"===typeof a&&null!==a&&"undefined"!==typeof a.success,g(a))},error:function(a){a=n(a);l(!1,g(a))}},f));c.async&&l(null);return null},mincheck:function(a,b){return this.minlength(a,b)},maxcheck:function(a,b){return this.maxlength(a,b)},rangecheck:function(a,b){return this.rangelength(a,b)}},init:function(a){var b=a.validators;a=a.messages;for(var c in b)this.addValidator(c,
...
function(){d(this).remove()}):d(this.ulError).remove()},reset:function(){this.isValid=null;this.removeErrors();this.validatedOnce=!1;this.errorClassHandler.removeClass(this.options.successClass).removeClass(this.options.errorClass);return this},manageError:function(a){d(this.ulError).length||this.manageErrorContainer();var b=a.name,c=!1!==this.options.errorMessage?"custom-error-message":b,e={};a=!1!==this.options.errorMessage?this.options.errorMessage:"type"===a.name?this.Validator.messages[b][a.requirements]:
...
a.hash)return this.items[b].destroy(),this.items.splice(b,1),!0;return!1},validate:function(a){var b=!0;"undefined"!==typeof this.$clickedElement&&!1===this.$clickedElement.data("cause-validation")&&(b=!1);var c=!0;if(b){this.focusedField=!1;for(b=0;b<this.items.length;b++)if("undefined"!==typeof this.items[b]&&!1===this.items[b].validate()&&(c=!1,!this.focusedField&&"first"===this.options.focus||"last"===this.options.focus))this.focusedField=this.items[b].$element;this.focusedField&&!c&&this.focusedField.focus()}this.options.listeners.onFormSubmit(c,
a,this);return c},isValid:function(){for(var a=0;a<this.items.length;a++)if(!1===this.items[a].isFieldValid())return!1;return!0},removeErrors:function(){for(var a=0;a<this.items.length;a++)this.items[a].parsley("reset")},destroy:function(){for(var a=0;a<this.items.length;a++)this.items[a].destroy();this.$element.off("."+this.type).removeData(this.type)},reset:function(){for(var a=0;a<this.items.length;a++)this.items[a].reset()}};d.fn.parsley=function(a,b){function c(c,f){var g=d(c).data(f);if(!g){switch(f){case "parsleyForm":g=
