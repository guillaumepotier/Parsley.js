/* Parsley dist/parsley.min.js build version 1.1.2 http://parsleyjs.org */
...
(/key/i.test(this.options.trigger)?"":" keyup");this.options.remote&&(a+=/change/i.test(a)?"":" change");if(a)this.$element.on(a.split(" ").join("."+this.type+" "),!1,d.proxy(this.eventValidation,this))},generateHash:function(){for(var a="",b=0;5>b;b++)a+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".charAt(Math.floor(52*Math.random()));return a},getHash:function(){return this.hash},getVal:function(){return this.$element.val()},eventValidation:function(a){var b=this.getVal();if("keyup"===
...
b:!0;d=this.applyValidators();this.errorBubbling&&this.manageValidationResult();return d},needsValidation:function(a){if(this.val===a&&this.validatedOnce)return!1;this.val=a;return this.validatedOnce=!0},applyValidators:function(){var a=null,b;for(b in this.constraints){var c=this.Validator.validators[this.constraints[b].name](this.val,this.constraints[b].requirements,this);!1===c?(a=!1,this.constraints[b].isValid=a):!0===c&&(this.constraints[b].isValid=!0,a=!1!==a)}return a},updateConstraint:function(a,
b,c){for(var d in this.constraints)if(this.constraints[d].name===a){this.constraints[d][b]=c;break}},manageValidationResult:function(){var a=null,b;for(b in this.constraints)!1===this.constraints[b].isValid?(this.addError(this.constraints[b]),a=!1):!0===this.constraints[b].isValid&&(this.removeError(this.constraints[b].name),a=!1!==a);this.isValid=a;return!0===this.isValid?(this.removeErrors(),this.errorClassHandler.removeClass(this.options.errorClass).addClass(this.options.successClass),this.options.listeners.onFieldSuccess(this.element,
this.constraints),!0):!1===this.isValid?(this.errorClassHandler.removeClass(this.options.successClass).addClass(this.options.errorClass),this.options.listeners.onFieldError(this.element,this.constraints),!1):a},removeError:function(a){a=this.ulError+" ."+a;this.ulError&&(d(a).remove()&&0===d(this.ulError).children().length)&&d(this.ulError).remove()},removeErrors:function(){!this.ulError||d(this.ulError).remove()},reset:function(){this.isValid=null;this.removeErrors();this.errorClassHandler.removeClass(this.options.successClass).removeClass(this.options.errorClass)},
addError:function(a){if(!this.ulError){var b="parsley-"+this.hash;this.ulError="#"+b;this.ulTemplate=d(this.options.errors.errorsWrapper).attr("id",b).addClass("parsley-error-list")}var c=a.name,b=this.ulError+" ."+c,e=d(this.options.errors.errorElem).addClass(c);a="type"===a.name?this.Validator.messages[c][a.requirements]:"undefined"===typeof this.Validator.messages[c]?this.Validator.messages.defaultMessage:this.Validator.formatMesssage(this.Validator.messages[c],a.requirements);d(this.ulError).length||
(this.options.errors.container(this.element,this.ulTemplate,this.isRadioOrCheckbox)||!this.isRadioOrCheckbox?this.$element.after(this.ulTemplate):this.$element.parent().after(this.ulTemplate));d(b).length||d(this.ulError).append(d(e).text(a))},addListener:function(a){for(var b in a)this.options.listeners[b]=a[b]}};var m=function(a,b){this.initMultiple(a,b);this.inherit(a,b)};m.prototype={constructor:m,initMultiple:function(a,b){this.element=a;this.$element=d(a);this.hash=this.getName();this.isRadioOrCheckbox=
!0;this.isRadio=this.$element.is("input[type=radio]");this.isCheckbox=this.$element.is("input[type=checkbox]");this.siblings='input[name="'+this.$element.attr("name")+'"]';this.$siblings=d(this.siblings);this.errorClassHandler=b.errors.classHandler(a)||this.$element.parent()},inherit:function(a,b){b=d.extend(!0,{},{messages:{mincheck:"You must select at least %s choices.",maxcheck:"You must select %s choices or less.",rangecheck:"You must select between %s and %s choices."}},b);var c=new h(a,b),e;
for(e in c)"undefined"===typeof this[e]&&(this[e]=c[e])},getName:function(){return this.$element.attr("name").replace(/(:|\.|\[|\])/g,"")},getVal:function(){if(this.isRadio)return d(this.siblings+":checked").val()||"";if(this.isCheckbox){var a=[];d(this.siblings+":checked").each(function(){a.push(d(this).val())});return a}}};var j=function(a,b){this.init("parsleyForm",a,b)};j.prototype={constructor:j,init:function(a,b,c){this.type=a;this.items=[];this.$element=d(b);this.options=c;var e=this;this.$element.find(c.inputs).each(function(){d(this).parsley(c);
...
onFieldSuccess:function(){}}};d(window).on("load",function(){d.fn.parsley.defaults=d.extend(!0,{},d.fn.parsley.defaults,"undefined"!==typeof window.ParsleyConfig?ParsleyConfig:{});d('[data-validate="parsley"]').each(function(){d(this).parsley()})})}(window.jQuery||window.Zepto);
