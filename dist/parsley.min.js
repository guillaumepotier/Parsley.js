...
"").replace(/\s+$/g,"");d(this.siblings).each(function(){d(this).on(b.split(" ").join("."+a.type+" "),!1,d.proxy(a.eventValidation,a))})}};var k=function(a,b,c){this.init(a,b,c||"parsleyForm")};k.prototype={constructor:k,init:function(a,b,c){this.type=c;this.items=[];this.$element=d(a);this.options=b;var f=this;this.$element.find(b.inputs).each(function(){f.addItem(this)});if(this.$element.is("form"))this.$form=this.$element;else{this.$form=this.$element.parents("form").first();this.$element.on("keypress",
"input",function(a){var b=d(this);if(""==b.attr("type")||"text"===b.attr("type"))13==(a.keyCode?a.keyCode:a.which)&&g(this,a)});this.$element.on("click","input[type=submit], button",function(a){g(this,a)});var g=function(a,b){(b.originalEvent?b.originalEvent.defaultPrevented:b.isDefaultPrevented())||d(a).attr("data-causedsubmit",!0)}}this.$form.on("submit."+this.type,!1,d.proxy(this.onSubmit,this))},addListener:function(a){for(var b in a)if(/Field/.test(b))for(var c=0;c<this.items.length;c++)this.items[c].addListener(a);
