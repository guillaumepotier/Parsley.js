...
"parsleyFieldMultiple"));return"function"===typeof b?b():h};d(window).on("load",function(){d("[parsley-validate], [data-parsley-validate]").each(function(){d(this).parsley()})});d.fn.domApi=function(a){var b,c={},e=RegExp("^"+a,"i");if("undefined"===typeof this[0])return{};for(var f in this[0].attributes)if(b=this[0].attributes[f],null!==b&&b.specified&&e.test(b.name)){var h=c,k=s(b.name.replace(a,"")),l;b=b.value;var g=void 0;try{l=b?"true"==b||("false"==b?!1:"null"==b?null:!isNaN(g=Number(b))?g:
/^[\[\{]/.test(b)?d.parseJSON(b):b):b}catch(m){l=b}h[k]=l}return c};var s=function(a){return a.replace(/-+(.)?/g,function(a,c){return c?c.toUpperCase():""})};d.fn.parsley.defaults={namespace:"parsley-",inputs:"input, textarea, select",excluded:"input[type=hidden], input[type=file], :disabled",allowCustomRequired:".example_custom_required_field",priorityEnabled:!0,trigger:!1,animate:!0,animateDuration:300,scrollDuration:500,focus:"first",validationMinlength:3,successClass:"parsley-success",errorClass:"parsley-error",
