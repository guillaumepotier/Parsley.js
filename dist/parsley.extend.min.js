...
luhn:function(a,b,c){a=a.replace(/[ -]/g,"");var e,d,f;b=0;f=a.split("").reverse();c=e=0;for(d=f.length;e<d;c=++e)a=f[c],a=+a,c%2?(a*=2,b=10>a?b+a:b+(a-9)):b+=a;return 0===b%10},americandate:function(a,b,c){if(!/^([01]?[1-9])[\.\/-]([0-3]?[0-9])[\.\/-]([0-9]{4}|[0-9]{2})$/.test(a))return!1;c=a.split(/[.\/-]+/);a=parseInt(c[1],10);b=parseInt(c[0],10);c=parseInt(c[2],10);if(0==c||0==b||12<b)return!1;var d=[31,28,31,30,31,30,31,31,30,31,30,31];if(0==c%400||0!=c%100&&0==c%4)d[1]=29;return 0<a&&a<=d[b-
