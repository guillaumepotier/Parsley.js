...
return a>=b[0]&&a<=b[1]},greaterthan:function(a,b,c){c.options.validateIfUnchanged=!0;return new Number(a)>new Number(d(b).val())},lessthan:function(a,b,c){c.options.validateIfUnchanged=!0;return new Number(a)<new Number(d(b).val())},beforedate:function(a,b){return Date.parse(a)<Date.parse(d(b).val())},afterdate:function(a,b){return Date.parse(d(b).val())<Date.parse(a)},luhn:function(a){a=a.replace(/[ -]/g,"");var b,c,d,f,e;c=0;e=a.split("").reverse();b=d=0;for(f=e.length;d<f;b=++d)a=e[b],a=+a,b%
2?(a*=2,c=10>a?c+a:c+(a-9)):c+=a;return 0===c%10}},messages:{minwords:"This value should have %s words at least.",maxwords:"This value should have %s words maximum.",rangewords:"This value should have between %s and %s words.",greaterthan:"This value should be greater than %s.",lessthan:"This value should be less than %s.",beforedate:"This date should be before %s.",afterdate:"This date should be after %s.",luhn:"This value should pass the luhn test."}})})(window.jQuery||window.Zepto);
