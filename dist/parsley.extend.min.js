/* Parsley dist/parsley.extend.min.js build version 1.1.16-dev http://parsleyjs.org */
...
a.replace(/[ -]/g,"");var b,c,e,d,f;c=0;f=a.split("").reverse();b=e=0;for(d=f.length;e<d;b=++e)a=f[b],a=+a,b%2?(a*=2,c=10>a?c+a:c+(a-9)):c+=a;return 0===c%10},americandate:function(a){if(!/^\d{2}\/\d{2}\/\d{4}$/.test(a))return!1;var b=a.split("/");a=parseInt(b[1],10);var c=parseInt(b[0],10),b=parseInt(b[2],10);if(0>b||0>=c||12<c)return!1;var d=[31,28,31,30,31,30,31,31,30,31,30,31];if(0==b%400||0!=b%100&&0==b%4)d[1]=29;return 0<a&&a<=d[c-1]}},messages:{minwords:"This value should have %s words at least.",
